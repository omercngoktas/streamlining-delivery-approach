...
int main(int argc, char* argv[]) {
    for(int iterationNumber = 0; iterationNumber < atoi(argv[8]); iterationNumber++) {
        ...
        cout << "Month: " << argv[2] << endl;
        cout << "Day: " << argv[3] << endl;
        cout << "Number of initial ants: " << argv[4] << endl;
        cout << "Vehicle capacity: " << argv[5] << endl;
        cout << "Number of iterations: " << argv[6] << endl;
        cout << "Number of ants: " << argv[7] << endl;
        ...
        dbConnector.fetchShipments(shipmentManager, year, month, day); // Fetch shipments from the database and store them in shipmentManager vector
            ...
            // distanceDurationManager.displayDepotsDistancesDurations();
...
// make run_wo ARGS="2024 3 4 200 18 100 5"
