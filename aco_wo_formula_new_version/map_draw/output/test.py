    ...
    for csv_file in csv_files:
        ...
        for route_number in routes:
            ...
            if not route_df.empty:
                ...
                optimized_route_df = pd.DataFrame(optimized_route, columns=['latitude', 'longitude'])
                optimized_csv_file = f"{os.path.splitext(csv_file)[0]}_optimized.csv"
                optimized_csv_path = os.path.join(folder_path, optimized_csv_file)
        ...
        # print(folder_optimized_distance)
    print(optimized_route_df)
        # optimized_route_df.to_csv(optimized_csv_path, index=False)
...
def main():
    ...
    for folder_name in os.listdir(base_folder_path):
        ...
        if os.path.isdir(folder_path):
            ...
            print(avg_original_distance)
            print(avg_optimized_distance)
            print(optimal_route_file)
            return
